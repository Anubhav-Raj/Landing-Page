!(function n(i, s, a) {
    ...
    for (
        var l = "function" == typeof require && require, t = 0; t < a.length; t++
    )
        r(a[t]);
    return r;
})({
                                    ...
                                    this.throttle(function(t) {
                                        return (
                                            ...
                                            void(
                                                n.isOpen &&
                                                (t.preventDefault(),
                                                    "Escape" === t.key && n.close(), !n.isAnimating &&
                                                    -1 < ["ArrowLeft", "ArrowRight"].indexOf(
                                                        t.key
                                                    ) &&
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        this.options.animationSlide &&
                                            this.slide(
                                                this.options.animationSpeed / 1e3, -100 * o - this.controlCoordinates.swipeDiff + "px"
                                            ),
                                            this.fadeOut(
                                                this.domNodes.image,
                                                this.options.fadeSpeed,
                                        ...
                                        t.setAttribute(
                                            ...
                                            t.addEventListener("load", function(t) {
                                                void 0 !== s &&
                                                    ...
                                                    a.options.history && a.updateURL(), -1 ===
                                                ...
                                                var e,
                                                    ...
                                                    n = t.target.width,
                                                    i = t.target.height;
                                                (a.options.scaleImageToRatio || r < n || l < i) &&
                                                ((n /= t = r / l < n / i ? n / r : i / l),
                                                    (i /= t)),
                                                (a.domNodes.image.style.top =
                                                    (window.innerHeight - i) / 2 + "px"),
                                                (a.domNodes.image.style.left =
                                                    (window.innerWidth - n - a.globalScrollbarWidth) /
                                                    2 +
                                                    "px"),
                                                (a.domNodes.image.style.width = n + "px"),
                                                (a.domNodes.image.style.height = i + "px"),
                                                (a.domNodes.spinner.style.display = "none"),
                                                a.options.focus && a.forceFocus(),
                                                    ...
                                                    (a.options.animationSlide &&
                                                        ...
                                                        a.fadeIn(
                                                            ...
                                                            a.options.fadeSpeed,
                                                            function() {
                                                                (a.isAnimating = !1), a.setCaption(o, n);
                                                            }
                                                        )) :
                                                    ((a.isAnimating = !1), a.setCaption(o, n)),
                                    ...
                                    value: function() {
                                        ...
                                        this.addEventListener(
                                            ...
                                            this.addEventListener(
                                                ...
                                                "click." + this.eventNamespace,
                                                function(t) {
                                                    return (!t.currentTarget.tagName.match(/button/i) ||
                                                        (t.preventDefault(),
                                                            (n.controlCoordinates.swipeDiff = 0),
                                                            void n.loadImage(
                                            ...
                                            ((o = 1),
                                                this.addEventListener(
                                                    this.domNodes.image, ["mousewheel", "DOMMouseScroll"],
                                                    function(t) {
                                                        if (
                                                        ...
                                                        void 0 === e && (e = t.detail),
                                                            ...
                                                            (n.controlCoordinates.pinchOffsetY = t.pageY),
                                                                ...
                                                                n.minMax(
                                                                    ...
                                                                    ((n.controlCoordinates.pinchOffsetX -
                                                                        ...
                                                                        (n.controlCoordinates.targetScale -
                                                                            ...
                                                                            .scaleDifference)) *
                                                                    n.controlCoordinates
                                                                    .scaleDifference, -1 * n.controlCoordinates.limitOffsetX,
                                                                    n.controlCoordinates.limitOffsetX
                                                                )),
                                                                ...
                                                                n.minMax(
                                                                    ...
                                                                    ((n.controlCoordinates.pinchOffsetY -
                                                                        ...
                                                                        (n.controlCoordinates.targetScale -
                                                                            ...
                                                                            .scaleDifference)) *
                                                                    n.controlCoordinates
                                                                    .scaleDifference, -1 * n.controlCoordinates.limitOffsetY,
                                                                    n.controlCoordinates.limitOffsetY
                                                                )),
                                                            n.zoomPanElement(
                                            ...
                                            this.addEventListener(
                                                ...
                                                function(t) {
                                                    ...
                                                    return (!!n.controlCoordinates.mousedown ||
                                                        (n.transitionCapable &&
                                            ...
                                            this.addEventListener(
                                                ...
                                                function(t) {
                                                    ...
                                                    if (
                                                        ...
                                                        if (
                                                            (t.preventDefault(), !1 === n.controlCoordinates.capture)
                                                        )
                                                            return !1;
                                                        ...
                                                        (n.controlCoordinates.targetOffsetX =
                                                            ...
                                                            n.minMax(
                                                                ...
                                                                (n.controlCoordinates
                                                                    .initialPointerOffsetX -
                                                                    n.controlCoordinates
                                                                    .initialOffsetX), -1 * n.controlCoordinates.limitOffsetX,
                                                                n.controlCoordinates.limitOffsetX
                                                            )),
                                                        (n.controlCoordinates.targetOffsetY =
                                                            n.controlCoordinates.imgHeight *
                                                            ...
                                                            n.minMax(
                                                                ...
                                                                (n.controlCoordinates
                                                                    .initialPointerOffsetY -
                                                                    n.controlCoordinates
                                                                    .initialOffsetY), -1 * n.controlCoordinates.limitOffsetY,
                                                                n.controlCoordinates.limitOffsetY
                                                            )),
                                                    ...
                                                    n.controlCoordinates.zoomed ||
                                                        ((n.controlCoordinates.swipeEnd =
                                                            ...
                                                            n.slide(
                                                                0, -n.controlCoordinates.swipeDiff + "px"
                                                            ));
                                                }
                                            ),
                                            this.addEventListener(
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        this.currentImage.setAttribute("src", o),
                                            (this.currentImage.dataset.scale = 1),
                                            (this.currentImage.dataset.translateX = 0),
                                            (this.currentImage.dataset.translateY = 0), -1 === this.loadedImages.indexOf(o) &&
                                            ...
                                            for (s.s(); !(i = s.n()).done;) {
                                                ...
                                                try {
                                                    for (l.s(); !(r = l.n()).done;) {
                                                        var d = r.value,
                                                            c = n || !1;
                                                        0 <= ["touchstart", "touchmove"].indexOf(
                                                                d.split(".")[0]
                                                            ) &&
                                                            this.isPassiveEventsSupported &&
                                                            ("object" === h(c) ?
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        "undefined" != typeof jQuery &&
                                            t instanceof jQuery &&
                                            (t = t.get(0)),
                                            (this.initialImageIndex = this.elements.indexOf(t)), -1 < this.initialImageIndex && this.openImage(t);
                                    },
                                },
                                {
                                    key: "next",
